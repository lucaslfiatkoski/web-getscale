      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações dos dispositivos GS-404, GS-100 e GS-501 com os modelos da marca Queclink. Acesse abaixo o modelo desejado para instruções completas de instalação e configuração.
            </p>
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/queclink-404/gv50' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  GV50M📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração via software Manage Tool e comandos SMS para o modelo GV50M.
            </p>
            <p className="text-gray-600 mb-2">
              • <Link to= '/queclink-404/gv58' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  GV58CG / GV58CEU📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração via software Manage Tool e comandos SMS para os modelos GV58CG e GV58CEU.
            </p>
            <p className="text-gray-600 mb-2">
              • <Link to= '/queclink-404/gv75' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  GV75 / GV75M📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração via software Manage Tool e comandos SMS para os modelos GV75 e GV75M.
            </p>
            <p className="text-gray-600 mb-2">
              • <Link to= '/queclink-404/gv300' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  GV300 / GV300M 📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração via software Manage Tool e comandos SMS para os modelos GV300 e GV300M.
            </p>
          </div>
