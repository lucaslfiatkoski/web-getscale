      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações dos dispositivos GS-404, GS-100 e GS-501 com os modelos da marca Multiportal. Acesse abaixo o modelo desejado para instruções completas de instalação e configuração.
            </p>
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/multiportal-404/rstmini' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline"> RST VT2 10 vias / RST Mini 12 vias📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções de ligação elétrica e configuração no software Multiportal VT2 10 Vias e RST Mini 12 vias.
            </p>
            <p className="text-gray-600 mb-2">
              • <Link to= '/multiportal-404/vt2' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline"> RST VT2 8 vias📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções de ligação elétrica e configuração no software Multiportal VT2 8 Vias.
            </p>
          </div>
