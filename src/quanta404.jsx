      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações dos dispositivos GS-404, GS-100 e GS-501 com os modelos da marca Quanta. Acesse abaixo o modelo desejado para instruções completas de instalação e configuração.
            </p>
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/quanta-404/frotav2' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  Radar Frota V2📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração do rastreador Radar Frota V2 com os dispositivos GS-404, GS-100 e GS-501.
            </p>
