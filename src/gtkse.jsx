...
const wireColors = [
    ...
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Azul', rastreadorBg: 'bg-blue-500' },
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <Link to="/getrak-404" className="text-blue-600 hover:underline">Integrações Getrak</Link>
                  <span> / gs404GTKSE4GPRO</span>
                </div>

                {/* Title */}
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS-404 e GS-501 com Getrak GTK SE 4G PRO
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração do modelo GTK SE 4G PRO com suporte a OneWire.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS-404 e GS-501 x GTK SE 4G PRO
                  </h2>
...
                </div>
                  ...
                  <div className="mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 mt-2">
                      Certifique-se de que a função OneWire esteja ativa no acessório antes de utilizá-la.
                    </p>
                  </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração –  GTK SE 4G PRO
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        📌 Passo 1 – Configuração da Porta OneWire
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        No software de configuração do rastreador, configure a porta OneWire do rastreador para modo <strong>Ibutton</strong>.
                      </p>
