...
import Gv50m from './assets/gv50m.png'
...
const wireColors = [
    ...
    { acessorio: 'Verde', acessorioBg: 'bg-green-600', funcao: '📤 TX (Transmissão) - Ligado ao RX do Rastreador', rastreador: 'Laranja', rastreadorBg: 'bg-orange-500' },
    { acessorio: 'Laranja', acessorioBg: 'bg-orange-500', funcao: '📥 RX (Recepção) - Ligado ao TX do Rastreador', rastreador: 'Cinza', rastreadorBg: 'bg-gray-500' },
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS-404 e GS-501 com Queclink GV50M
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração do modelo GV50M com suporte a RS232.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS-404 e GS-501 x Queclink GV50M
                  </h2>
...
                </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – GV50M
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Manage Tool – GV50M
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700">
                        Acesse o <strong>GV50MB Manage Tool</strong>, e vá até <strong>Serial Port Application - Serial Port Setting.</strong>
                      </p>
                      ...
                      <li><strong>Working Mode: </strong> 3 - RFID UART.</li>
                      ...
                      <li><strong>Sleep Enable:</strong>, desmarcado.</li>
                      <li><strong>RFID Type:</strong>, 2 (MR2 RFID).</li>
                    </ul>
                    ...
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Caso prefira configurar via SMS, envie o comando abaixo para o chip inserido no rastreador:
                      </p>
                      <p className="border text-center text-gray-700 mb-4 break-words">
                        <strong>AT+GTURT=gv50m,3,7,8,1,0,0,,2,,FFFF$</strong>
                      </p>
                      <p className="text-gray-700 mb-4">
                        O rastreador deve responder confirmando a aplicação da configuração.
                      </p>
