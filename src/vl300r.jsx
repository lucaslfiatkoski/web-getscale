...
function Entrack300r() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 overflow-x-hidden">
      ...
      {/* MAIN */}
      <main className="flex-1 py-10"> {/* removido overflow-x-hidden */}
        <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8"> {/* reduzido de 7xl para 5xl */}
          <div className="flex gap-6">
            <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter max-w-4xl mx-auto"> {/* limitando largura do conteúdo */}
              ...
              <section id="tabela-cores" className="mb-12">
                ...
                <div className="overflow-x-auto bg-white rounded-lg shadow border border-gray-200">
                  <table className="w-full border-collapse text-sm sm:text-base table-auto"> {/* ajustado */}
                    <thead>
