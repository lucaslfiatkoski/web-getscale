      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações do dispositivo GS-302 com os modelos da marca Suntech. 
            ...
            <p className="text-gray-600 mb-3">
              • <Link to= '/suntech-302/gs43053' // <<< Este é o caminho correto para o seu Link
                className=" text-lg text-blue-600 underline">ST4305 / ST8300 / ST8300H 📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções completas para ligação dos fios e configuração dos modelos ST4305, ST8300 e ST8300H com suporte a RS232 
            </p>
            <p className="text-gray-600 mb-3">
              • <Link to= '/suntech-302/gs300h3' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">ST300H / ST300HD / ST300R 📍</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções completas para ligação dos fios e configuração dos modelos ST300H, ST300HD e ST300R com suporte a RS232 
            </p>
            <p className="text-gray-600 mb-3">
              • <Link to= '/suntech-302/gs3403' // <<< Este é o caminho correto para o seu Link
            ...
            <p className="text-gray-600 mb-3">
              • <Link to= '/suntech-302/gs8300r3' // <<< Este é o caminho correto para o seu Link
            ...
            <p className="text-gray-600 mb-3">
              • <Link to= '/suntech-302/gs8310r3' // <<< Este é o caminho correto para o seu Link
