      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações dos dispositivos GS-404, GS-100 e GS-501 com os modelos da marca Getrak. Acesse abaixo o modelo desejado para instruções completas de instalação e configuração.
            </p>
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/getrak-404/gtkse' // <<< Este é o caminho correto para o seu Link
                className="text-lg text-blue-600 underline">  GTK SE 4G PRO</Link>
            </p>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Instruções específicas para instalação física e configuração do rastreador Getrak GTK SE 4G PRO com os dispositivos <br></br>GS-404, GS-100 e GS-501.
            </p>
          </div>
