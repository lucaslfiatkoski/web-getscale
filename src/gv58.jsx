...
const wireColors = [
    ...
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Rosa', rastreadorBg: 'bg-rose-300' },
...
                </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – GV58CG e GV58CEU
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Manage Tool – GV58CG e GV58CEU
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700">
                        Acesse o <strong>Manage Tool</strong>, e vá até <strong>Other Settings - 1-wire Device Settings</strong>
                      </p>
                      <p className="text-gray-700 mb-4">
                       Configure o campo <strong> Ibutton Timer </strong> com o valor <strong>2 segundos</strong> para garantir a leitura correta do cartão.
                      </p>
                    ...
                    <CardContent>
                      ...
                      <p className="text-gray-700 mb-4">
                        Após o envio, aguarde o retorno de confirmação da configuração.
                      </p>
