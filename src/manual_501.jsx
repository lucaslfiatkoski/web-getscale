        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto p-4 sm:p-8 bg-white shadow-xl rounded-2xl font-inter">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              A correta instalação do GS-501 é fundamental para seu perfeito funcionamento. Siga atentamente o diagrama de ligação abaixo.
            </p>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Com o equipamento corretamente instalado, ao ligar a ignição do veículo (sinal positivo no fio azul), o GS-501 aciona o bloqueio e começa a emitir um alerta sonoro, informando que o motorista deve se identificar.
            </p>
            
            <p className="font-semibold text-gray-700 mt-4 mb-2">Para se identificar, o motorista pode:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              <li>
                <span className="font-bold">Digitar a Senha:</span> Inserir a senha numérica no teclado e pressionar o botão  <span className="text-green-600 font-semibold">verde</span> (✔) para confirmar. O alerta sonoro cessa ao primeiro dígito. Para cancelar e digitar novamente, basta usar o botão <span className="text-red-600 font-semibold">vemelho</span> (X).
              </li>
              <li>
                <span className="font-bold">Aproximar o Cartão:</span> Apresentar o cartão RFID ao leitor e aguardar 3 bipes curtos, confirmando a leitura. <p> Obs. ( Apenas na versão GS-501+)</p>
              </li>
            </ul>
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              O GS-501 pode ser usado para registrar a entrada de passageiros ou senhas genericas. Uma vez ativa, com o veículo ligado, o leitor se mantém ativo e toda senha ou cartão apresentado será enviado ao sistema como uma identificação de passageiro.
            </p>
            <CommandTable 
              title="Comandos de Configuração"
              data={[
