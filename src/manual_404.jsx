              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <p className="text-base text-gray-600"> Inverter RX e TX: TX do acessório no RX do rastreador 
                      e RX do acessório no TX do rastreador.</p>
                  </div>
                  <div className="bg-white p-6 rounded-xl shadow-lg">
                    <h4 className="font-semibold mb-2 text-lg">3. Configuração</h4>
                    <p className="text-base text-gray-600">Configurar porta RS232 do rastreador para 19200 Bps.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
