...
const wireColors = [
    ...
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Laranja', rastreadorBg: 'bg-yellow-500' },
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  ...
                  <span> / gs404st300w</span>
                </div>

                {/* Title */}
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS404 e GS-501 com Suntech 8310W
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração do modelo 8310W com suporte a OneWire.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS404 e GS-501 x 8310W
                  </h2>
                      ...
                      <tbody>
                        {wireColors.map((row, index) => (
                          <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3">
                              <div className={`${row.rastreadorBg} ${row.rastreador === 'Branco' || row.rastreador === 'NC' || row.rastreador === 'Laranja' ? 'text-gray-900' : 'text-white'} px-3 py-2 rounded font-medium text-center`}>
                                {row.rastreador}
                              </div>
                            </td>
                          </tr>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração –  8310W
                  </h2>
                  ...
                  <Card className="shadow-lg">
                    ...
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        No software <strong>SyncTrack</strong>, configure a porta OneWire do rastreador para modo <strong>Ibutton</strong>.
                      </p>
