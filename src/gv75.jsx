...
const wireColors = [
    ...
    { acessorio: 'Verde', acessorioBg: 'bg-green-600', funcao: '📤 TX (Transmissão) - Ligado ao RX do Rastreador', rastreador: 'Roxo', rastreadorBg: 'bg-purple-500' },
...
                </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – GV75 e GV75M
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Manage Tool – GV75 
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700">
                        Acesse o <strong> Manage Tool</strong>, e vá até <strong>Serial Port Application - Serial Port Setting.</strong>
                      </p>
                      ...
                      <li><strong>Working Mode: </strong> RFID UART.</li>
                      ...
                      <li><strong>Sleep Enable:</strong> Disable the device sleep and the serial port sleep mode.</li>
                      <li><strong>RFID Type:</strong> 2.</li>
                    </ul><br></br>
                    <p className="text-gray-700 mb-4">
                    ...
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Manage Tool – GV75M
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                         <p className="text-gray-700">
                        No modelo GV75M, o menu está em <strong>Serial Port  - Serial Port Setting.</strong>
                      </p>
                      <p className="text-gray-700 mb-4">
                      ...
                      <li><strong>Stop Bits:</strong> 1.</li>
                      <li><strong>Parity Bit:</strong> None.</li>
                      <li><strong>Sleep Enable:</strong>  Disable the device sleep mode.</li>
                      <li><strong>RFID Type:</strong> 2 (MR2).</li>
                    </ul><br></br>
                      <p className="text-gray-700 mb-4">
