...
const wireColors = [
    ...
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Verde com Amarelo', rastreadorBg: 'bg-gradient-to-r from-green-600 from-80% to-yellow-300 to-50%' },
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <Link to="/ruptela-404" className="text-blue-600 hover:underline">Integrações Ruptela</Link>
                  <span> / gs404trace5</span>
                </div>
...
                </div>
                  ...
                  <div className="mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 mt-2">
                      O modelo  <strong>Trace5</strong>da Ruptela utiliza exclusivamente a  <strong>interface OneWire (fio cinza)</strong>  para leitura de cartões iButton.
                    </p>
                    <p className="text-gray-700 mt-2">
                     Conecte apenas o fio <strong>Cinza</strong> do acessório ao fio <strong>Verde com Amarelo</strong> do rastreador.
                    </p>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – Trace5
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Ruptela Device Center
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        Para ativar o modo de leitura via iButton/1-Wire, siga os passos abaixo utilizando o <strong>Ruptela Device Center</strong> no modo <strong>Advanced Configurator:</strong>
                      </p>
                      <p className="text-gray-700">
                        1. Acesse a seção <strong>Driver registration</strong> e clique em <strong>Options:</strong>
                      </p>
                      ...
                      <p className="text-gray-700">
                        2. Na janela que se abrir, em  <strong>Registration function</strong>,  selecione:
                      </p>
                      <ul className="text-gray-700 mt-2 space-y-1 ml-4 list-disc list-inside">
                      <li><strong>Mandatory registration</strong> -  para exigir autenticação.</li>
                      <li>ou <strong>Blocking</strong> - para bloqueio completo sem cartão.</li>
                    </ul><br></br>
                    <p className="text-gray-700 mb-3">
                        3. Marque a opção <strong>Passenger registration</strong> caso queira permitir autenticação de passageiros 👥
                      </p>
                      <p className="text-gray-700 mb-3" >
                        4. No campo <strong>Registration source</strong>, selecione <strong>iButton</strong> como origem da leitura.
                      </p>
                      {/* SyncTrack Image */}
                      <div className="mb-6 bg-white p-4 rounded-lg shadow border border-gray-200">
                        <img
                      ...
                      <p className="text-gray-700" >
                        📌 Após aplicar as configurações, salve no dispositivo clicando em <strong>Save to device</strong>
                      </p>
                      <p className="text-gray-700 mb-3" >
                        Em seguida, aproxime um cartão iButton para validar o funcionamento da autenticação.
                      </p>
                    </CardContent>
                  </Card>
