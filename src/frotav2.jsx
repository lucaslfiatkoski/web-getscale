...
const wireColors = [
    ...
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Cinza com Branco', rastreadorBg: 'bg-gradient-to-r border from-gray-600 from-80% to-white to-50%' },
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <Link to="/quanta-404" className="text-blue-600 hover:underline">Integrações Quanta</Link>
                  <span> / gs404v2</span>
                </div>

                {/* Title */}
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS-404 e GS-501 com Quanta Radar Frota V2
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração do modelo Radar Frota V2 com suporte a 1-wire.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS-404 e GS-501 x Quanta Radar Frota V2
                  </h2>
...
                </div>
                ...
                <div className="mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 mt-2">
                      <strong>O rastreador Quanta Radar Frota V2 já possui a porta OneWire ativa de fábrica.</strong>
                    </p>
                    <p className="text-gray-700 mt-2">
                      Não é necessário realizar nenhuma configuração adicional para que o GS-404 funcione corretamente com este modelo.
                    </p>
                    <p className="text-gray-700 mt-2 font-semibold">
                      🔌Basta realizar a ligação elétrica conforme indicado na tabela de cores.
                    </p>
                  </div><br></br>
