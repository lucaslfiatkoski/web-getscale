      ...
      <section id="suporte" className="py-10 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
            ...
            <p>
              Esta página contém as integrações dos dispositivos GS-601 com os modelos da marca Multiportal. Acesse abaixo o modelo desejado para instruções completas de instalação e configuração.
            </p>
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/multiportal-601/rst601' // <<< Este é o caminho correto para o seu Link
            ...
            <p className="text-gray-600 mb-2">
              • <Link to= '/multiportal-601/vt2601' // <<< Este é o caminho correto para o seu Link
