...
const wireColors = [
    ...
    { acessorio: 'Azul', acessorioBg: 'bg-blue-600', funcao: '🚗 Ignição', rastreador: 'Amarelo', rastreadorBg: 'bg-yellow-300' },
    { acessorio: 'Verde', acessorioBg: 'bg-green-600', funcao: '📤 TX (Transmissão) - Ligado ao RX do Rastreador', rastreador: 'NC', rastreadorBg: 'bg-gray-300' },
    { acessorio: 'Laranja', acessorioBg: 'bg-orange-500', funcao: '📥 RX (Recepção) - Ligado ao TX do Rastreador', rastreador: 'NC', rastreadorBg: 'bg-gray-300' },
    { acessorio: 'Cinza', acessorioBg: 'bg-gray-500', funcao: '🧬 OneWire', rastreador: 'Verde', rastreadorBg: 'bg-green-600' },
            ...
            <div className="flex gap-6">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <Link to="/teltonika-404" className="text-blue-600 hover:underline">Integrações Teltonika</Link>
                  <span> / gs404fmc</span>
                </div>

                {/* Title */}
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS-404 e GS-501 com Teltonika FMC125 / FMC130
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração dos modelos FMC125 / FMC130 com suporte a OneWire.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS-404 e GS-501 x Teltonika FMC125 / FMC130
                  </h2>
...
                </div>
                  ...
                  <div className="mt-6 bg-green-50 border-l-4 border-green-500 p-4 rounded-lg">
                    ...
                    <p className="text-gray-700 mt-2">
                      Os modelos <strong>FMC125 e FMC130</strong> utilizam exclusivamente a <strong>interface OneWire (fio cinza)</strong> para comunicação com o acessório.
                    </p>
                  </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – FMC125 / FMC130
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Software Teltonika
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        A configuração da leitura RFID para o GS-404 nos rastreadores Teltonika é feita através do <strong>Teltonika Configurator</strong>.
                      </p>
                      <p className="text-gray-700 mb-4">
                       Siga os passos abaixo:
                      </p>
                      <ul className="text-gray-700 mt-2 space-y-1 ml-4 list-disc list-inside">
                      <li>Acesse o configurador e conecte o rastreador via USB.</li>
                      <li>No menu lateral, vá até <strong>Authorization ID List</strong>.</li>
                      <li>No painel lateral direito, certifique-se de que a opção<strong>1-Wire Mode</strong> está marcada como  <strong>Matrix (ReadROM) ✅</strong>.</li>
                    </ul><br></br>
                      ...
                      <div className="mb-6 bg-white p-4 rounded-lg shadow border border-gray-200">
                        <img
                          ...
                          className="w-full mx-auto rounded border border-gray-200"
                        />
                      </div><br></br>
                      <p className="text-gray-700 mb-4">
                       📌 Não é necessário configurar portas seriais RS232. A leitura é feita diretamente via OneWire (entrada de iButton).
                      </p>

                    </CardContent>
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        📌 Verifique o modo de retenção do cartão
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700 mb-4">
                        No menu lateral esquerdo, acesse <strong>Trip / Odometer</strong> e localize a seção <strong>Advanced Trip Settings.</strong>
                      </p>
                      <p className="text-gray-700 mb-4">
                        Certifique-se de que a opção <strong>Remember iButton/RFID </strong>esteja ativada com o botão <strong>Enable</strong> selecionado ✅. Isso garante que o rastreador memorize o último cartão autorizado durante o percurso.
                      </p>
