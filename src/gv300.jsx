...
import Gv300p from './assets/gv300p.png'
...
const wireColors = [
    ...
    { acessorio: 'Azul', acessorioBg: 'bg-blue-600', funcao: '🚗 Ignição', rastreador: 'Branco', rastreadorBg: 'bg-white border' },
    { acessorio: 'Verde', acessorioBg: 'bg-green-600', funcao: '📤 TX (Transmissão) - Ligado ao RX do Rastreador', rastreador: 'Verde com rosa', rastreadorBg: 'bg-gradient-to-r from-green-600 from-80% to-rose-300 to-50%' },
    { acessorio: 'Laranja', acessorioBg: 'bg-orange-500', funcao: '📥 RX (Recepção) - Ligado ao TX do Rastreador', rastreador: 'Preto com branco', rastreadorBg: 'bg-gradient-to-r border from-black from-80% to-white to-50%' },
          ...
          <div className="max-w-7xl mx-auto px-4 lg:px-8">
              ...
              <div className="flex-1 bg-white shadow-xl rounded-2xl p-6 sm:p-8 font-inter">
                ...
                <div className="text-sm text-gray-500 mb-4">
                  <Link to="/queclink-404" className="text-blue-600 hover:underline">Integrações Queclink</Link>
                  <span> / gs404gv300</span>
                </div>

                {/* Title */}
                <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 border-b pb-3 mb-6">
                  <Pin className="inline w-6 h-6 mr-2 text-blue-600" /> GS-100, GS-404 e GS-501 com Queclink GV300 e GV300M
                </h1>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Instruções completas para ligação dos fios e configuração dos modelos GV300 e GV300M com suporte a RS232.
                </p>
                ...
                <section id="tabela-cores" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    🎨 Tabela de Cores – GS-100, GS-404 e GS-501 x Queclink GV300 e GV300M
                  </h2>
...
                </div>
                ...
                <section id="configuracao" className="mb-12">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2">
                    <Cpu className="w-6 h-6 text-blue-600" /> Configuração – GV300 e GV300M
                  </h2>

                  <Card className="shadow-lg">
                    <CardHeader>
                      <CardTitle className="text-xl text-gray-800">
                        ⚙️ Configuração no Manage Tool
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-gray-700">
                        Acesse o menu <strong>Serial Port Application - Serial Port Settings.</strong>
                      </p>
                      <p className="text-gray-700 mb-4">
                       Configure os campos conforme a imagem abaixo:
                      </p>
                      ...
                      <div className="mb-6 bg-white p-4 rounded-lg shadow border border-gray-200">
                        <img
                          ...
                          className="w-full  mx-auto rounded  border-gray-200"
                        />
                      </div><br></br>
                      <ul className="text-gray-700 mt-2 space-y-1 ml-4 list-disc list-inside">
                      <li><strong>Working Mode: </strong> Use specific RFID card reader to communicate with UART.</li>
                      <li><strong>Baud Rate:</strong> 19200.</li>
                      <li><strong>Data Bits:</strong> 8.</li>
                      <li><strong>Stop Bits:</strong> 1.</li>
                      <li><strong>Parity Bit:</strong> None.</li>
                      <li><strong>Sleep Enable:</strong> Desativado.</li>
                      <li><strong>RFID Type:</strong> MR2.</li>
                    </ul><br></br>
                    ...
                    <CardContent>
                         <p className="text-gray-700">
                        Se preferir configurar via SMS, envie um dos comandos abaixo para o chip do rastreador:
                      </p>
                      <ul className="border text-center text-gray-700 mb-4 break-words">
                      <li><strong>Para GV300: </strong> AT+GTURT=gv300,3,7,8,1,0,0,0,2,0,FFFF$ </li>
                      <li><strong>Para GV300M: </strong> AT+GTURT=gv300m,3,7,8,1,0,0,0,2,0,FFFF$</li>
                    </ul><br></br>
                      <p className=" text-gray-700 mb-4">
                        O rastreador irá responder por SMS confirmando que a configuração foi aplicada com sucesso.
                      </p>
